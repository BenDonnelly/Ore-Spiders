...
public class EntityOreSpider extends EntityMob{
	...
	public IEntityLivingData onSpawnWithEgg(IEntityLivingData p_110161_1_)
	{
		...
		{
			p_110161_1_1 = new EntityOreSpider.GroupData();
			...
			{
				((EntityOreSpider.GroupData) p_110161_1_1).func_111104_a(this.worldObj.rand);
			}
		}

		if(p_110161_1_1 instanceof EntityOreSpider.GroupData)
		{
			int i = ((EntityOreSpider.GroupData) p_110161_1_1).field_111105_a;

...
public class EntityRegister 
{
	...
	public static void registerEntities()
	{
        ...
        EntityRegistry.registerGlobalEntityID(EntityQuartzSpider.class, "NetherQuartzSpider", EntityRegistry.findGlobalUniqueEntityId());
        registerEntityEgg(EntityQuartzSpider.class, blackColour, netherQuartzColour);
        EntityRegistry.addSpawn(EntityQuartzSpider.class, 10, 4, 4, EnumCreatureType.monster, BiomeGenEnd.hell);

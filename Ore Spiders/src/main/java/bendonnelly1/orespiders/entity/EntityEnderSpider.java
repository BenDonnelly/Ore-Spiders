...
public class EntityEnderSpider extends EntityMob {
    ...
    private boolean shouldAttackPlayer(EntityPlayer p_70821_1_) {
        ...
        if (itemstack != null && itemstack.getItem() == Item.getItemFromBlock(Blocks.pumpkin)) {
            ...
            Vec3 vec31 = Vec3.createVectorHelper(this.posX - p_70821_1_.posX, this.boundingBox.minY
                    + (double) (this.height / 2.0F) - (p_70821_1_.posY + (double) p_70821_1_.getEyeHeight()), this.posZ
                    - p_70821_1_.posZ);
    ...
    protected boolean teleportToEntity(Entity par1Entity) {
        Vec3 vec3 = Vec3.createVectorHelper(this.posX - par1Entity.posX, this.boundingBox.minY
                + (double) (this.height / 2.0F) - par1Entity.posY + (double) par1Entity.getEyeHeight(), this.posZ
                - par1Entity.posZ);
        vec3 = vec3.normalize();
        double d0 = 16.0D;
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData p_110161_1_) {
        ...
        if (p_110161_1_1 == null) {
            ...
            if (this.worldObj.difficultySetting == EnumDifficulty.HARD
                    && this.worldObj.rand.nextFloat() < 0.1F * this.worldObj.func_147462_b(this.posX, this.posY,
                            this.posZ)) {
